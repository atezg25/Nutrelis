    ...
    <nav style={{
      ...
      <div style={{ display: "flex", gap: 32, alignItems: "center" }}>
        {["Produits", "Science", "Avis clients", "FAQ"].map((item) => (
          <a key={item} href="#" style={{ color: "rgba(255,255,255,0.75)", fontSize: 14, fontWeight: 500, textDecoration: "none", transition: "color 0.2s" }}
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center", width: "100%" }}>
          ...
          <div style={{ position: "relative", display: "flex", justifyContent: "center" }}>
            ...
            <img
              ...
              style={{
                width: "80%", maxWidth: 420, height: "auto",
            ...
            >
              ...
              <div style={{
                ...
                <img
                  ...
                  style={{ width: "80%", maxWidth: 240, height: "auto", objectFit: "contain", filter: "drop-shadow(0 10px 30px rgba(29,185,84,0.2))" }}
                />
              </div>
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 60, marginBottom: 48 }}>
            ...
            {/* Liens */}
            {[
              { titre: "Produits", liens: ["Astaxanthine 12mg", "Collagène Marin", "Oméga-3"] },
              { titre: "Entreprise", liens: ["À propos", "Science", "Blog"] },
              { titre: "Support", liens: ["FAQ", "Contact", "Livraison", "Retours"] },
            ].map((col, i) => (
              <div key={i}>
                <p style={{ color: "#fff", fontWeight: 700, fontSize: 14, marginBottom: 20 }}>{col.titre}</p>
                {col.liens.map((lien, j) => (
                  <a key={j} href="#" style={{ display: "block", color: "rgba(255,255,255,0.45)", fontSize: 14, marginBottom: 12, textDecoration: "none" }}>{lien}</a>
                ))}
              </div>
            ))}
          </div>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <p style={{ color: "rgba(255,255,255,0.3)", fontSize: 13 }}>© 2025 NUTRELIS. Tous droits réservés.</p>
            <p style={{ color: "rgba(255,255,255,0.3)", fontSize: 13 }}>Made with ❤️ en Afrique</p>
          </div>
        </div>
      </footer>
    </main>
