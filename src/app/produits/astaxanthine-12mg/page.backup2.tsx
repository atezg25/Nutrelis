            ...
            <div style={{ flex: 1 }}>
              ...
              {pack.eco && mode === "unique" && (
                <div style={{ fontSize: 12, color: "var(--asta-gold)", fontWeight: 700, marginTop: 2 }}>
                  ✓ Économisez {pack.eco && mode === "unique" && (
  <span style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ color: "#fff", fontSize: 8, fontWeight: 800, letterSpacing: 1 }}>
              MONEY BACK
            </span>
            <span style={{ color: "#fff", fontSize: 26, fontWeight: 900, lineHeight: 1, margin: "2px 0" }}>
              90
            </span>
     ...
     {/* NUTRELIS VS AUTRES */}
      ...
      <section style={{ padding: "80px 60px", background: "var(--asta-bg2)" }}>
        <div style={{ maxWidth: 820, margin: "0 auto", textAlign: "center" }}>
          <div style={{
            background: "#fff",
            border: "2px solid var(--asta-accent)",
            borderRadius: 28,
            padding: "64px 56px",
            boxShadow: "0 8px 48px rgba(125,8,6,0.1)",
          }}>
            <div style={{ fontSize: 64, marginBottom: 24 }}>🛡️</div>
            <h2 style={{ fontSize: "2rem", fontWeight: 800, fontFamily: "var(--font-sora), sans-serif", marginBottom: 16 }}>
              Garantie 90 jours{" "}
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginBottom: 36 }}>
              {["✅ Aucune question posée", "✅ Remboursement intégral", "✅ Simple et rapide"].map((b, i) => (
                <span key={i} style={{ background: "#fdecea", color: "var(--asta-text2)", padding: "8px 18px", borderRadius: 24, fontSize: 14, fontWeight: 600 }}>
                  {b}
                </span>
              ))}
            </div>
